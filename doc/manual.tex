...
\begin{figure}
    ...
    \subfigure[Temperature contour]{
        \includegraphics[width=7cm,height=6.8cm]{temperature.eps}
    }
    \subfigure[Heat flux]{
        \includegraphics[width=7cm,height=6.8cm]{heatflux.eps}
    }
    \subfigure[U-velocity along vertical center line]{
        \includegraphics[width=7cm,height=6.8cm]{vline.eps}
    }
    \subfigure[V-velocity along horizontal center line]{
        \includegraphics[width=7cm,height=6.8cm]{hline.eps}
    }
